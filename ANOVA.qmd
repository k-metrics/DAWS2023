...
subset(PatientStress, PatientStress$年齢区分 == c("青年", "壮年"),
       drop = TRUE) %>% 
  with(wilcox.test(ストレス反応得点 ~ 年齢区分, alternative="two.sided"))

subset(PatientStress, PatientStress$年齢区分 == c("青年", "中年"),
       drop = TRUE) %>% 
  with(wilcox.test(ストレス反応得点 ~ 年齢区分, alternative="two.sided"))

subset(PatientStress, PatientStress$年齢区分 == c("青年", "高年"),
       drop = TRUE) %>% 
  with(wilcox.test(ストレス反応得点 ~ 年齢区分, alternative="two.sided"))

subset(PatientStress, PatientStress$年齢区分 == c("壮年", "中年"),
       drop = TRUE) %>% 
  with(wilcox.test(ストレス反応得点 ~ 年齢区分, alternative="two.sided"))

subset(PatientStress, PatientStress$年齢区分 == c("壮年", "高年"),
       drop = TRUE) %>% 
  with(wilcox.test(ストレス反応得点 ~ 年齢区分, alternative="two.sided"))

subset(PatientStress, PatientStress$年齢区分 == c("中年", "高年"),
       drop = TRUE) %>% 
  with(wilcox.test(ストレス反応得点 ~ 年齢区分, alternative="two.sided"))
